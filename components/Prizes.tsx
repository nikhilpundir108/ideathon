...
const prizes = [
  {
    ...
    position: '1st Prize',
    amount: '₹5,000',
    description: 'Cash Prize + Certificate + Incubation Opportunity',
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {prizes.map((prize, index) => (
            <motion.div
              ...
              className={index === 0 ? 'md:scale-110 md:mt-0' : 'md:mt-8'}
            >
              <div
              ...
              >
                ...
                <div className="absolute -top-6 left-1/2 transform -translate-x-1/2">
                  <div
                    className={`w-16 h-16 bg-gradient-to-br ${prize.color} rounded-full flex items-center justify-center shadow-lg ${prize.glowColor} group-hover:scale-110 transition-transform duration-300 ring-4 ring-slate-900`}
                  >
                ...
                <div className="text-center mt-8">
                  ...
                  <div className="relative inline-block mb-4">
                    <div
                      className={`text-5xl font-bold bg-gradient-to-r ${prize.color} bg-clip-text text-transparent`}
                    >
                      {prize.amount}
                    </div>
                  </div>
