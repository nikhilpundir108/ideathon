...
import { Building, Sparkles, Zap, Code } from 'lucide-react';

const sponsors = [
  { name: 'Tech Innovations Inc', icon: Code },
  { name: 'Future Labs', icon: Sparkles },
  { name: 'Digital Ventures', icon: Zap },
  { name: 'Innovation Hub', icon: Building },
];
          ...
          {sponsors.map((sponsor, index) => (
            ...
            >
              <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8 h-full flex flex-col items-center justify-center gap-4 hover:border-blue-500/30 hover:scale-105 transition-all duration-300 group">
                <div className="w-20 h-20 bg-gradient-to-br from-blue-600/20 to-cyan-600/20 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <sponsor.icon className="w-10 h-10 text-blue-400" />
                </div>
        ...
        >
          <div className="bg-gradient-to-br from-blue-900/20 to-slate-800/20 backdrop-blur-sm border border-blue-500/20 rounded-2xl p-8 max-w-2xl mx-auto">
            <p className="text-slate-300 text-lg mb-4">
              Interested in sponsoring Ideathon 2K25?
            </p>
            <a
